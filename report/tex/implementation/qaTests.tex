...
\QATEST{M3: Modifying logic of an existing component}{Bart}{22.04.2018}{Design Time}{Wishes to modify the logic of an existing component}{less than 30 min}{about 30 min}{success}{No unit tests has been created for the project.}
%
...
% {less than 15 seconds in average}
% {success}
