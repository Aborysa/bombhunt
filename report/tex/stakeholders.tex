...
\unnumberedSection[lecturer]{Lecturer and Course Assistants}
...
\unnumberedSection[otherGroups]{ATAM Evaluators}
...
\unnumberedSection[developmentTeam]{Development Team}
...
\unnumberedSection[players]{Game Players}
